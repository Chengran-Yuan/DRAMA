...
def worker_map_cuda(worker: WorkerPool, fn: Callable[..., List[Any]], input_objects: List[Any], num_gpus=1) -> List[Any]:
    """
    ...
    scattered_objects = worker.map(Task(fn=fn, num_gpus=num_gpus), object_chunks)
