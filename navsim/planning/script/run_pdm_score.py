...
from navsim.planning.utils.multithreading.worker_utils import worker_map_cuda
...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.eval_on_gpu:
        score_rows: List[Tuple[Dict[str, Any], int, int]] = worker_map_cuda(worker, run_pdm_score, data_points)
    else:
